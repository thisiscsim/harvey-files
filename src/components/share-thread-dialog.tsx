...
export default function ShareThreadDialog({ isOpen, onClose }: ShareThreadDialogProps) {
  ...
  const [users, setUsers] = useState<User[]>([
    { id: "1", email: "harvey.specter@whitfieldcrane.com", initial: "H", artifactAccess: "full", threadAccess: "full", sourcesAccess: "full" },
    { id: "2", email: "litt.gang@whitfieldcrane.com", initial: "L", artifactAccess: "full", threadAccess: "full", sourcesAccess: "full" },
    { id: "3", email: "jessica@whitfieldcrane.com", initial: "J", artifactAccess: "view", threadAccess: "view", sourcesAccess: "view" },
    { id: "4", email: "rachel@whitfieldcrane.com", initial: "R", artifactAccess: "view", threadAccess: "view", sourcesAccess: "view" },
  ]);
        ...
        <div className="space-y-1">
          ...
          <div className="w-full flex items-center justify-between p-2 rounded-lg">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-fg-base">mike.ross@whitfieldcrane.com (you)</span>
            </div>
