...
export default function ShareArtifactDialog({ isOpen, onClose, artifactTitle }: ShareArtifactDialogProps) {
  ...
  const [users, setUsers] = useState<User[]>([
    { id: "1", email: "harvey.specter@whitfieldcrane.com", initial: "H", access: "full" },
    { id: "2", email: "litt.gang@whitfieldcrane.com", initial: "L", access: "full" },
    { id: "3", email: "jessica@whitfieldcrane.com", initial: "J", access: "view" },
    { id: "4", email: "rachel@whitfieldcrane.com", initial: "R", access: "view" },
  ]);
